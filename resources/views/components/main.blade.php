...
<head>
    ...
    <!-- Icon -->
    <link href="https://dryaslibrary.herokuapp.com/assets/favicon.ico" rel="shortcut icon" type='image/x-icon' />
    <link href='https://dryaslibrary.herokuapp.com/assets/favicon-32x32.png' rel='icon' sizes='32x32' />
    <link href='https://dryaslibrary.herokuapp.com/assets/android-icon-192x192.png' rel='icon' sizes='192x192' />
    <link href='https://dryaslibrary.herokuapp.com/assets/apple-icon-180x180.png' rel='apple-touch-icon'
        sizes='180x180' />
    <meta content='https://dryaslibrary.herokuapp.com/assets/apple-icon-114x114.png' name='msapplication-TileImage' />
    <link
    ...
    <div class="nk-main">
                        ...
                        <div class="row">
                                ...
                                <div class="nk-blog-post">
                                    ...
                                    <div class="nk-post-by">
                                        <img src="assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle"
                                            width="35"> by <a href="https://nkdev.info">Wolfenstein</a> in Jul 23, 2018
                                    </div>
                                    <div class="nk-gap"></div>
                                    <div class="nk-post-text">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="nk-blog-post">
                                    ...
                                    <div class="nk-post-by">
                                        <img src="assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle"
                                            width="35"> by <a href="https://nkdev.info">Wolfenstein</a> in Jul 3, 2018
                                    </div>
                                    <div class="nk-gap"></div>
                                    <div class="nk-post-text">
                                        <p>This little wandering journey, without settled place of abode, had been so
        ...
        -->
                                <ul class="nk-social-links-3 nk-social-links-cols-4">
                                    ...
                                    <li><a class="nk-social-twitter" href="https://twitter.com/nkdevv"
