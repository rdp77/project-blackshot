...
-------------------------------------------------------------------*/
            ...
            function isInViewport($item, returnRect) {
                ...
                if (rect.right <= 0 || rect.left >= wndW) {
                    ...
                    var beforeBottom = Math.max(
                        0,
                        rect.top + rect.height - wndH
                    );
                    if (rect.height < wndH) {
                ...
                _createClass(GOODGAMES, [
                    ...
                    },
                    {
                        ...
                        value: function isInViewport($item, returnRect) {
                            return _utility.isInViewport.call(
                                this,
                                $item,
                                returnRect
                            );
                    ...
                    },
                    {
                        ...
                        value: function initNavbarDropEffect1() {
                            return _initNavbarDropEffect2.initNavbarDropEffect1.call(
                                this
                            );
                        },
                    },
                    {
                        ...
                        value: function initBackgrounds($context) {
                            return _initBackgrounds2.initBackgrounds.call(
                                this,
                                $context
                            );
                        },
                    ...
                    },
                    {
                        ...
                        value: function initFormsMailChimp() {
                            return _initFormsMailChimp2.initFormsMailChimp.call(
                                this
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function initPluginFastClick() {
                            return _initPluginFastClick2.initPluginFastClick.call(
                                this
                            );
                        },
                    },
                    {
                        ...
                        value: function initPluginNano($context) {
                            return _initPluginNano2.initPluginNano.call(
                                this,
                                $context
                            );
                        },
                    ...
                    },
                    {
                        ...
                        value: function initPluginModal($context) {
                            return _initPluginModal2.initPluginModal.call(
                                this,
                                $context
                            );
                        },
                    },
                    {
                        ...
                        value: function initPluginTabs($context) {
                            return _initPluginTabs2.initPluginTabs.call(
                                this,
                                $context
                            );
                        },
                    ...
                    },
                    {
                        ...
                        value: function initPluginSeiyriaBootstrapSlider(
                            $context
                        ) {
                ...
                $navbarTop
                    .on("mouseenter", "li.nk-drop-item", function () {
                        ...
                        var $openedSiblings = $item
                            ...
                            .add(
                                $item.parents(".nk-nav:eq(0)").siblings(".open")
                            )
                            .add(
                                $item
                                    .parents(".nk-nav:eq(0)")
            ...
            function initNavbarSide() {
                ...
                function updateTogglers() {
                    (0, _utility.$)("[data-nav-toggle]").each(
                        function eachNavToggle() {
                            ...
                            (0, _utility.$)(this)[
                                (active ? "add" : "remove") + "Class"
                            ]("active");
                        }
                    );
                }
                self.toggleSide = function ($side, speed) {
                    self[$side.hasClass("open") ? "closeSide" : "openSide"](
                        $side,
                        speed
                    );
                };
                self.openSide = function ($side, speed) {
                    ...
                    _utility.tween.to($side, speed || 0.4, {
                        x: $side.hasClass("nk-navbar-left-side")
                            ? "100%"
                            : "-100%",
                        force3D: true,
                    });
                ...
                self.closeSide = function ($side, speed) {
                    ...
                    if (
                        !$sideNavs.filter(".nk-navbar-overlay-content.open")
                            .length
                    ) {
                        // hide overlay
                        _utility.tween.to($overlay, 0.3, {
                    ...
                    if (isFirst) {
                        ...
                        if (
                            ...
                            if (openNav) {
                                sidePos = Math.min(
                                    navSize,
                                    Math.max(0, startSwipe - endSwipe)
                                );
                            }
                            ...
                            if (closeNav) {
                                ...
                                sidePos =
                                    navSize -
                                    Math.abs(
                                        Math.max(-navSize, Math.min(0, curPos))
                                    );
                            }
                            ...
                            if (openNav) {
                                sidePos = Math.min(
                                    navSize,
                                    Math.max(0, endSwipe - startSwipe)
                                );
                            }
                            ...
                            if (closeNav) {
                                ...
                                sidePos =
                                    navSize -
                                    Math.abs(
                                        Math.max(-navSize, Math.min(0, curPos2))
                                    );
                            }
            ...
            function initCounters() {
                ...
                $progressCount.each(function () {
                    (0, _utility.$)(this)
                        .attr(
                            "data-nk-count",
                            (0, _utility.$)(this).attr("data-progress")
                        )
                        .attr(
                            "data-nk-mask",
                        ...
                        .css(
                            "width",
                            ((0, _utility.$)(this).attr("data-nk-count-from") ||
                                "0") + "%"
                        )
...
-------------------------------------------------------------------*/
            function initStore() {
                ...
                _utility.$doc.on("click", "a.nk-product-rating", function (e) {
                    ...
                    if (isHash) {
                        var $hashBlock = (0, _utility.$)(isHash).parents(
                            ".nk-tabs:eq(0)"
                        );
                        if ($hashBlock.length) {
            ...
            function initNewsBox() {
                _utility.$doc.on(
                    ...
                    function () {
                        ...
                        if (
                            $info.find(".nk-news-box-item-image > img").length
                        ) {
                            $info
                ...
                (0, _utility.$)(
                    ".nk-news-box .nk-news-box-item-active"
                ).trigger("click");
            }
            ...
            function initAnchors() {
                        ...
                        if (isHash && isURIsame) {
                            ...
                            try {
                                ...
                                if (
                                    ...
                                    // scroll to block
                                    self.scrollTo(
                                        $hashBlock.length ? $hashBlock : hash
                                    );
                ...
                $anchorItems.each(function () {
                    ...
                    if ((hash && $block.length) || hash === "top") {
                        ...
                        if (inArray === false) {
                            ...
                            anchorBlocks[inArray].$item = anchorBlocks[
                                inArray
                            ].$item.add($item);
                        }
                    }
                ...
                function setAnchorActiveItem(type, ST) {
                    for (var k = 0; k < anchorBlocks.length; k++) {
                        var item = anchorBlocks[k];
                        var active =
                            ST >= item.activate && ST < item.deactivate;
                        item.$item[active ? "addClass" : "removeClass"](
                            "active"
                        );
                    }
                }
                ...
                function stopGif(item) {
                    ...
                    if (item.gifPlaying) {
                        ...
                        $item
                            ...
                            .attr(
                                "src",
                                $item.find("img").attr("data-gif-static")
                            );
                    }
                }
...
-------------------------------------------------------------------*/
            function initInfoBoxes() {
                ...
                _utility.$doc.on(
                    ...
                    function (e) {
                        e.preventDefault();
                        var $box = (0, _utility.$)(this).parents(
                            ".nk-info-box:eq(0)"
                        );
                    ...
                    function () {
                        (0, _utility.$)(this).validate({
                            ...
                            submitHandler: function submitHandler(form) {
                                var $responseSuccess = (0, _utility.$)(
                                    form
...
-------------------------------------------------------------------*/
            function initFormsMailChimp() {
                ...
                if (
                    typeof _utility.$.validator === "undefined" ||
                    !$mchimp.length
                ) {
                    return;
                }
                ...
                _utility.$.validator.addMethod(
                    ...
                    function (value, element, options) {
                        ...
                        var isValid =
                            numberFilled === 0 || numberFilled >= options[0];
                        // Store the cloned validator for future validation
                        $fieldsFirst.data("valid_skip", validator);
                ...
                $mchimp.each(function () {
                    ...
                    var validator = $form.validate({
                        ...
                        submitHandler: function submitHandler() {
                            var $responseSuccess = $form.find(
                                ".nk-form-response-success"
                            );
                            var $responseError = $form.find(
                                ".nk-form-response-error"
                            );
            ...
            function initAudioPlayer() {
                ...
                PlayersPlain.prototype = {
                    ...
                    step: function step() {
                        ...
                        self.$timer[0].innerHTML = self.formatTime(
                            Math.round(seek)
                        );

                        if (!progressBusy) {
                            self.$progress[0].style.width =
                                (self.progress * 100 || 0) + "%";
                        }
                    },
                ...
                if (typeof Hammer !== "undefined") {
                    ...
                    $progresses.each(function () {
                        ...
                        var HammerProgress = new Hammer.Manager(
                            $curProgressCont[0]
                        );
                        HammerProgress.add(
                            new Hammer.Pan({
                        ...
                        HammerProgress.on("pan press pressup", function (e) {
                            ...
                            if (e.type === "press" || progressStart === false) {
                                ...
                                progressStart =
                                    ...
                                    $curProgressCont[0].getBoundingClientRect()
                                        .left;
                            ...
                            progressCurW = Math.min(
                                ...
                                Math.max(
                                    0,
                                    (progressStart + e.deltaX) / progressW
                                )
                            );
                            $curProgres[0].style.width =
                                progressCurW * 100 + "%";
                ...
                soundManager.onready(function () {
                    if ($playersPlain.length) {
                        $playersPlain.each(function () {
                            this.audioAPI = new PlayersPlain(
                                (0, _utility.$)(this)
                            );
                        });
                    }
 ...
 -------------------------------------------------------------------*/
            function initImageSlider() {
                ...
                $sliders.each(function () {
                    var $this = (0, _utility.$)(this);
                    var autoplay =
                        parseInt($this.attr("data-autoplay"), 10) || false;
                    var slides = [];
                    var defaultSlide = 0;
                    ...
                    function stopAutoplay() {
                        ...
                        if (!dontTouchCount) {
                            $thumbs
                                .find(".nk-image-slider-thumbs-count")
                                .remove();
                        }
                    }
                    function runAutoplay() {
                        ...
                        autoplayInterval = setInterval(function () {
                            ...
                            var currentTime =
                                autoplayStart + autoplay - new Date();
            ...
            function initInstagram() {
                ...
                $instagram.each(function () {
                    ...
                    var options = {
                        ...
                        loadingText:
                            self.options.templates.instagramLoadingText,
                    ...
                    if (window.location.protocol === "file:") {
                        $this.html(
                            '<div class="col-12">' + options.failText + "</div>"
                        );
                        // eslint-disable-next-line
                        console.error(
                    ...
                    $this.html(
                        '<div class="col-12">' + options.loadingText + "</div>"
                    );
                    ...
                    _utility.$.getJSON(
                        ...
                        function (response) {
                            ...
                            for (var i = 0; i < options.count; i++) {
                                ...
                                $this.append(
                                    templating(tempData, options.template)
                                );
                            }
            ...
            function initTwitter() {
                ...
                $twtFeeds.each(function () {
                    ...
                    var options = {
                        ...
                        hideReplies:
                            $this.attr("data-twitter-hide-replies") === "true",
                        template:
...
-------------------------------------------------------------------*/
                ...
                (0, _utility.$)(".nk-sidebar-sticky").each(function () {
                    ...
                    $this
                        ...
                        .stick_in_parent({
                            ...
                            recalc_every: 50,
                            offset_top:
                                parseInt($this.attr("data-offset-top"), 10) ||
                                130,
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function initPluginFlickity() {
                ...
                // carousel
                (0, _utility.$)(".nk-carousel > .nk-carousel-inner").each(
                    function () {
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function initPluginPhotoswipe() {
                ...
                function parseThumbnailElements(el) {
                    var thumbElements = (0, _utility.$)(el).find(
                        "a.nk-gallery-item"
                    );
                    var items = [];
                    ...
                    thumbElements.each(function eachThumbs() {
                        ...
                        size = (
                            this.getAttribute("data-size") || "1920x1080"
                        ).split("x");
                        ...
                        var mediumSrc =
                            this.getAttribute("data-med") || item.src;
                        if (mediumSrc) {
                            size = (
